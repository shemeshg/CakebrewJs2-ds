...
QVector<FormulaRow> ShellCmd::parseFormulaList(QString &strResult)
{
...
QVector<CaskRow> ShellCmd::parseCaskList(QString &strResult)
{
...
QVector<SearchResultRow *> ShellCmd::parseCmdSearch(QString searchResult, bool isCask)
{
